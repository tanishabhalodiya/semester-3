...
('Jeet Patel',' Surat' ,31),
('Vijay Raval',' Rajkot' ,30)SP_RENAME 'EMPLOYEE.AGR','AGE'SELECT * FROM EMPLOYEE
--1. Create table Employee_detail from Employee with all the columns and data.

SELECT * INTO EMPLOYEE_DETAIL FROM EMPLOYEE
--2. Create table Employee_data from Employee with first two columns with no data.

SELECT NAME,CITY INTO EMPLYEE_DETAIL FROM EMPLOYEE WHERE 1=2
...
UPDATE DEPOSITE SET ACTNO='111' , AMOUNT='5000' WHERE CNAME='SANDEEP'

--4. Update amount of KRANTI to 7000. (Use Deposit Table)
UPDATE BRANCH SET AMOUNT=7000 WHERE NAME='KRANTI'

--5. Update branch name from ANDHERI to ANDHERI WEST. (Use Branch Table)
UPDATE BRANCH SET BNAME='ANDHERI WEST' WHERE BNAME='ANDHERI'

--6. Update branch name of MEHUL to NEHRU PALACE. (Use Deposit Table)
UPDATE DEPOSITE SET BNAME='NEHRU PALACE' WHERE CNAME='MEHUL'
...
UPDATE DEPOSITE SET AMOUNT=5000 , ADATE='1996-4-1' WHERE CNAME='PRAMOD'
